...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const msgToTraditionalChinese = '<i class="hnfont icon-panben"></i><span>轉為繁體</span>' // 此处可以更改为你想要显示的文字
  const msgToSimplifiedChinese = '<i class="hnfont icon-jianben"></i><span>转为简体</span>' // 同上，但两处均不建议更改
