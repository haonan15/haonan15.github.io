document.addEventListener('DOMContentLoaded', function () {
  ...
  const addHighlightTool = function () {
    ...
    if (isHighlightShrink !== undefined) {
      highlightShrinkEle = `<i class="hnfont icon-arrow-down-s-line expand ${highlightShrinkClass}"></i>`
    }

    if (isHighlightCopy) {
      highlightCopyEle = '<div class="copy-notice"></div><i class="hnfont icon-copy-fill copy-button"></i>'
    }
    ...
    function createEle (lang, item, service) {
      ...
      if (highlightHeightLimit && item.offsetHeight > highlightHeightLimit + 30) {
        ...
        ele.innerHTML = '<i class="hnfont icon-arrow-double-down"></i>'
